...
class MainActivity : FragmentActivity() {
    ...
    private lateinit var rowSites: LinearLayout
    ...
    override fun onLowMemory() {
        ...
        com.karin.streamtv.util.WebViewExtractor.destroy()
    }
    ...
    private fun createSiteCard(site: SiteConfig, @Suppress("UNUSED_PARAMETER") index: Int): View {
        val card = layoutInflater.inflate(R.layout.item_site_card, rowSites, false)
